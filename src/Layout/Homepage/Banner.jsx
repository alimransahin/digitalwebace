...
<div className="bg-[url('https://img.freepik.com/free-vector/wavy-shape-business-background-paper-cut-style_1017-33399.jpg?w=996&t=st=1688910107~exp=1688910707~hmac=652475589fe29a187ddec29b414e9664c0907311ce8a44a85a8b9323a9a2302b')] cabin px-10 flex justify-center items-center bg-cover bg-no-repeat min-h-[90vh]">
...
<span className="relative">Hire Us !</span>
  ...
  <img src="https://img.freepik.com/premium-vector/painter-cartoon-character_88465-1949.jpg?w=740" alt="" className="w-3/4 mx-auto h-96" />
