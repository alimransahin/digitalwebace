...
return (
<div>
<nav className="px-10 py-6 navbg flex justify-center items-center">
  <div className="container flex flex-wrap justify-between items-center cabin mx-auto">
    ...
    <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
      ...
      <li className="text-black md:hover:text-blue-700 md:p-0 m-0">
          <Link to="/" className="block md:font-md lg:text-lg px-3 ">Home</Link>
        </li>
        <li className="text-black md:hover:text-blue-700 md:p-0 m-0">
          <Link to="#about" className="block md:font-md lg:text-lg px-3 ">About</Link>
        </li>
        <li className="text-black md:hover:text-blue-700 md:p-0 m-0">
          <Link to="services" className="block md:font-md lg:text-lg px-3 ">Services</Link>
        </li>
        <li className="text-black md:hover:text-blue-700 md:p-0 m-0">
          <Link to="#faq" className="block md:font-md lg:text-lg px-3 ">FAQ</Link>
        </li>
        <li className="text-black md:hover:text-blue-700 md:p-0 m-0">
