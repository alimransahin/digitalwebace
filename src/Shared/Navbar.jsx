...
const Navbar = () => {
  return (
    <div>
      <nav className="px-10 h-[10vh] navbg flex justify-center items-center ">
        <div className="container flex flex-wrap justify-between items-center cabin mx-auto">
          <Link to="/" className="flex">
            ...
            <span className="self-center text-lg font-semibold whitespace-nowrap logo ">DigitalWebAce</span>
          </Link>
          ...
          <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
            ...
            <li>
                <Link to="/" className="block py-2 text-md pr-4 pl-3 hover:text-[#5194e0] text-[#6C9BCF] md:p-0 hover:border-b-2 border-[#EBD8B2]">Home</Link>
              </li>
              <li>
                <Link to="#about" className="block py-2 text-md pr-4 pl-3 hover:text-[#5194e0] text-[#6C9BCF] md:p-0 hover:border-b-2 border-[#EBD8B2]">About</Link>
              </li>
              <li>
                <Link to="#services" className="block py-2 text-md pr-4 pl-3 hover:text-[#5194e0] text-[#6C9BCF] md:p-0 hover:border-b-2 border-[#EBD8B2]">Services</Link>
              </li>
              <li>
                <Link to="#faq" className="block py-2 text-md pr-4 pl-3 hover:text-[#5194e0] text-[#6C9BCF] md:p-0 hover:border-b-2 border-[#EBD8B2]">FAQ</Link>
              </li>
              <li>
                <Link to="/contact" className="block py-2 text-md pr-4 pl-3 hover:text-[#5194e0] text-[#6C9BCF] md:p-0 hover:border-b-2 border-[#EBD8B2]">Contact</Link>
              </li>
            </ul>
          </div>
        </div>
