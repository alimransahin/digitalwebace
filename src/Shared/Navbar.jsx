...
<nav className="px-10 h-[10vh] navbg flex justify-center items-center rounded">
  <div className="container flex flex-wrap justify-between items-center cabin mx-auto">
    ...
    <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
      ...
      <li>
          <Link href="#home" className="block py-2  text-md pr-4 pl-3  md:hover:text-[#EBD8B2] text-[#6C9BCF] md:p-0 hover:border-b-2 border-[#EBD8B2] hover:text-white">Home</Link>
        </li>
        <li>
          <Link href="#about" className="block py-2  text-md pr-4 pl-3  md:hover:text-[#EBD8B2] text-[#6C9BCF] md:p-0 hover:border-b-2 border-[#EBD8B2] hover:text-white">About</Link>
        </li>
        <li>
          <Link href="#services" className="block py-2  text-md pr-4 pl-3  md:hover:text-[#EBD8B2] text-[#6C9BCF] md:p-0 hover:border-b-2 border-[#EBD8B2] hover:text-white">Services</Link>
        </li>
        <li>
          <Link className="block py-2  text-md pr-4 pl-3  md:hover:text-[#EBD8B2] text-[#6C9BCF] md:p-0 hover:border-b-2 border-[#EBD8B2] hover:text-white">FAQ</Link>
        </li>
        <li>
          <Link to="/contact" className="block py-2  text-md pr-4 pl-3  md:hover:text-[#EBD8B2] text-[#6C9BCF] md:p-0 hover:border-b-2 border-[#EBD8B2] hover:text-white">Contact</Link>
        </li>
      </ul>
    </div>
  </div>
